...
public class UzakPaletAcici : MonoBehaviour
{
    GameManager gm;
    ...
    public GameObject yanUretim;
    public FarAwayProduct farAwayProduct;
        ...
        if (a >= b && gm.money > 0)
        {
            ...
            if (mevcutPara >= alanAcmaUcreti)
            {
                if (duvar == null)
                {
                    ...
                    yanUretim.SetActive(true);
                    farAwayProduct.run = true;
